        ...
        while (isActive)
        {
            ...
            switch (generateType)
            {
                ...
                case 1:
                    ...
                    {
                        int sx = Mathf.RoundToInt(startPosition.x + (gridRotation.z.Equals(180) ? -gridScale.x + 1 : 0));   // 0 : 정방향, 180 : 역방향
                        int sz = Mathf.RoundToInt(startPosition.z + (gridRotation.x.Equals(180) ? -gridScale.z + 1 : 0));   // 0 : 정방향, 180 : 역방향
